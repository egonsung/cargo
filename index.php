...
<html lang="en">
<head>
  <?php include_once("SJB/php/meta.php");?>
</head>

<body>
  <main>
    <?php include_once("SJB/php/header.php");?>
    ...
    <div id="masterslider" class="master-slider ms-skin-default">
      ...
      <div class="ms-slide" data-delay="5" data-fill-mode="fill" data-id="slide1">
        <img src="SJB/slider/blank.gif" alt="" title="offroad-bg-slide1" data-src="SJB/assets/img/112156432.png" />
      ...
      data-offset-y="197"
      data-origin="tl"
      data-position="normal"><span class="text-uppercase g-font-size-48" style="line-height: 10px;">Need to ship</br>less-than-container-load cargo</br>into or out from China?</span></div>
      ...
      data-position="normal">
        ...
        <!-- <div class="ms-slide" data-delay="5" data-fill-mode="fill" data-id="slide2">
          <img src="SJB/slider/blank.gif" alt="" title="offroad-bg-slide2" data-src="SJB/assets/img/525883066.png" />
        ...
        <div class="ms-slide" data-delay="5" data-fill-mode="fill" data-id="slide3">
          <img src="SJB/slider/blank.gif" alt="" title="offroad-bg-slide3" data-src="SJB/assets/img/646805156.png" />
  ...
  <div class="dzsparallaxer auto-init height-is-based-on-content use-loading mode-scroll loaded dzsprx-readyall cargoLimitCon" data-options='{direction: "reverse", settings_mode_oneelement_max_offset: "150"}'>
  ...
  <?php include_once("SJB/php/footer.php"); ?>

  <!-- Go to Top -->
  <a class="js-go-to u-go-to-v1 g-width-40 g-height-40 g-color-secondary g-bg-main-opacity-0_5 g-bg-main--hover g-bg-main--focus g-font-size-12 rounded" href="#" data-type="fixed" data-position='{
  "bottom": 15,
  "right": 15
...
<?php include_once("SJB/php/javascript.php"); ?>
